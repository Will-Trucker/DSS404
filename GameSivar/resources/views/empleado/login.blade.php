...
<body class="bg-gray-100">
    ...
    <div class="flex items-center justify-center">
        <a href="{{ route('empleado.index') }}" class="bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded focus:outline-none focus:shadow-outline cursor-pointer">Regresar</a>
    </div>
